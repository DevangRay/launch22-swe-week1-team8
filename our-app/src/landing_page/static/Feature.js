const Feature = [
    ...
    },
    {
      title: 'Calendar',
      description:
        'A calendar summarizing all school-sponsored events taking place each month. A user can navigate to the calendar from the Home Page, and navigate through all months in the academic year to find all organized events taking place. An edit button allows administrators to remove events or add new events to the calendar with a time, title, and description.',
      imageUrl: process.env.PUBLIC_URL + '/images/calendar.webp',
      time: 1500,
    },
    {
